        ...
        <div class="container">
            ...
            <div class="row no-margin" >
                ...
                <div class="bg-layer d-flex col-md-12" style="text-align:center center; margin-bottom: 20px;margin-top:50px;" >
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    <a href="question"><button type="button"  class="btn  col-md-12" style="background-color: rgb(0,171,160);border-color:rgb(0,171,160); color:white">SEND A QUESTION</button></a>
                                </div>
                                <div class="col-md-3">
                ...
                <div class="bg-layer d-flex col-md-12" style="margin-top: 10px">
                    ...
                    <div class="container">
                        <div class="row">
                             <div class="col-md-12 " style="text-align: center;height: 50px;background-color: #9c9c9c!important;"><h3 style="margin-top: 5px">SEND A QUESTION</h3></div>
                        </div>
                    </div> 
                </div>
                ...
                <div class="bg-layer d-flex col-md-12" style="text-align: center; margin-bottom: 50px" >
                    <div class="container myshadow" >
                        <div class="row" style="margin-top: 30px">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" id="storyteller_name" onchange="onSelteller()">                                        
                                    @foreach ($storytellers as $storyteller)
                                        <option value="{{$storyteller -> id}}">{{$storyteller -> first_name . "   " .  $storyteller -> last_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="modal-content" style="margin-top: 200px" >
                                ...
                                <div class="container">
                                    <div class="row" style="text-align: center">
                                        ...
                                        <textarea style="width: 70%; margin-left:auto; margin-right:auto; height:80px; margin-top:10px" id="txtArea"></textarea>
                                    </div>
...
<script>
    var selCategory = "";
    var selTeller = document.getElementById("storyteller_name").value;
    var selQuery = "";
    ...
    function onSelteller () {        
        selTeller = document.getElementById("storyteller_name").value;
    }
